...
english.weaponry_cant_use = "Вы не можете взаимодействовать с данным объектом!"
english.weaponry_take_ammo = "Вам был выдан комплект боеприпасов для приписанного оружия."
english.weaponry_took_ammo_security_pt1 = "Вы уже взяли снаряжение! Проверьте Ваш инвентарь."
english.weaponry_took_ammo_security_pt2 = "Вам был выдан комплект снаряжения."
english.weaponry_took_ammo_already = "Вы уже брали снаряжение!"
...
english.abilities_fatjug = "Shows all your ammo"
english.abilities_name_fatjug = "Ammunition"
...
--QUICK CHAT
english.quickchat_request_id = "Request ID"
...
english.roundend_alphawarheadgoc = "Alpha-Warhead was blown up"
