...
addons/[weapons]_no_260_kk_ins2/lua/cw_kk/ins2/client/hands.lua
...
if CustomizableWeaponry_KK.ins2.isContentMounted4({Folder = "weapons/cw_kk_ins2_base_main"}) then
