...
addons/[begotten]_advmelee/lua/weapons/messerblade_onehanded.lua

--]]

AddCSLuaFile()

SWEP.PrintName		= "Messerblade"
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.Instructions	= ""
...
SWEP.ViewModel		= Model("models/weapons/shaky/mordhau/v_messerblade.mdl")
SWEP.WorldModel		= Model("models/weapons/shaky/mordhau/w_messerblade.mdl")
