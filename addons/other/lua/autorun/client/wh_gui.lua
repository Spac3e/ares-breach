...
addons/[weapons]_weapon_holsters/lua/autorun/client/wh_gui.lua
...
function Menu.Toggle()
	if LocalPlayer():IsSuperAdmin() or LocalPlayer():GetUserGroup() == "spectator" then
...
local function SpawnMenu_Entry(panel)
	...
	a:SetSize(0, 50)
	a:SetEnabled(LocalPlayer():IsSuperAdmin() or LocalPlayer():GetUserGroup() == "spectator")
end
