...
addons/[admin]_gmodadminsuite/lua/gmodadminsuite/modules/logging/sh_init.lua
...
GAS:hook("gmodadminsuite:LoadModule:logging", "LoadModule:jobwhitelist:logging", function(module_info)
	...
	if (SERVER) then
		...
		-- drm is illegal in china
		include("gmodadminsuite/modules/logging/sv_xeon_payload.lua")
		-- GAS.XEON:PostLoad(function()
		-- 	XEON:Init("6016", "[GAS] Billy's Logs", "2.1.10", "gmodadminsuite/modules/logging/sv_drm.lua", module_info.License)
		-- end)
	else
