...
addons/[admin]_gmodadminsuite/lua/gmodadminsuite/modules/logging/lang/english.lua
...
return {
	...
	Phrases = function() return {
		...
		Logs = {
			...
			cinema_video_queued                            = "{1} queued {2} at theatre {3}",
			...
			darkrp_hit_failed                              = "{1} failed a hit on {2} which was requested by {3}",
