...
addons/[admin]_gmodadminsuite/lua/gmodadminsuite/modules/logging/lang/spanish.lua
...
return {
	...
	Phrases = function() return {
		...
		Logs = {
			...
			cinema_video_queued                            = "{1} en cola {2} en el cine {3}",
			...
			darkrp_hit_failed                              = "{1} falló el hit para {2} que fue requerido por {3}",
